...
export const promptBuilders = {
  ...
  selectedText: {
    buildPrompt: (text, lang, length, format, tone) => {
      ...
      if (settings.isSummaryAdvancedMode && settings.selectedTextPromptSelection) {
        systemInstruction = settings.selectedTextCustomSystemInstructionContent || '';
  ...
  courseSummary: {
    buildPrompt: (text, lang, length, format, tone) => {
      ...
      if (settings.isSummaryAdvancedMode && settings.courseSummaryPromptSelection) {
        systemInstruction = settings.courseSummaryCustomSystemInstructionContent || '';
  ...
  courseConcepts: {
    buildPrompt: (text, lang, format, tone) => {
      ...
      if (settings.isSummaryAdvancedMode && settings.courseConceptsPromptSelection) {
        systemInstruction = settings.courseConceptsCustomSystemInstructionContent || '';
