// @ts-nocheck
export const openrouterModelsConfig = {
  'openrouter/auto': {
    name: 'OpenRouter Auto (Recommended)',
    generationConfig: {
      temperature: 0.6,
      topP: 0.91,
    },
  ...
  'deepseek/deepseek-r1-0528-qwen3-8b:free': {
    ...
    generationConfig: {}, // max_completion_tokens is null in source data
  },
  ...
  'nousresearch/hermes-2-pro-llama-3-8b': {
    // Note: This model's pricing is 0/0 in the source data, even though the id/name don't have ':free'
