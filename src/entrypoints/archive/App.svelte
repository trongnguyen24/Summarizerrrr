  ...
  >
    ...
    <div class="prose w-full py-16 max-w-3xl prose-xs mx-auto">
      <div>
        ...
        <div id="summary">
          <p>
            Tuyệt vời! Dưới đây là tóm tắt chi tiết về trải nghiệm "vibecoding"
            và những phản hồi thú vị từ cộng đồng Reddit:
          </p>
          ...
          <p>
            ...
            nghĩ chỉ cần nói cho Cursor biết mình muốn gì, và "Bùm!", một ứng
            dụng SaaS hoàn hảo sẽ ra đời ngay lập tức. Nghe có vẻ dễ dàng và
            thần kỳ đúng không? ✨
          </p>
          ...
          <p>
            Thực tế phũ phàng hơn nhiều! Chỉ sau 3 ngày, codebase của bạn tác
            giả biến thành một "nghĩa địa" của những tính năng bị tạo đi tạo
            lại. Cursor cứ thế tạo ra cùng một hàm dịch vụ đến 4 lần, mỗi lần
            lại hơi khác một chút. Hậu quả là bạn ấy phải mất tới 7 tiếng đồng
            hồ để sửa xung đột giữa các hàm mà đáng lẽ ra chúng làm cùng một
            việc! 🤦&zwj;♂️
          </p>
          <p>
            Mỗi khi bắt đầu một phiên chat mới với AI, bạn tác giả lại phải lặp
            đi lặp lại toàn bộ kiến trúc ứng dụng của mình. AI thì cứ gợi ý
            những thay đổi làm hỏng luôn cả những thứ vừa xây hôm qua. Thậm chí,
            nó còn "não cá vàng" quên béng luôn database schema (cấu trúc cơ sở
            dữ liệu) và gợi ý những cấu trúc bảng hoàn toàn khác biệt. Cứ như có
            một junior dev siêu thông minh nhưng hay quên vậy! 😅
          </p>
          ...
          <p>
            ...
            Điều kỳ diệu đã xảy ra! Với cùng một AI, cùng một dự án, nhưng giờ
            đây nó lại xây dựng chính xác những gì bạn ấy muốn. Công việc mà
            trước đây tốn 6 tiếng để debug, giờ chỉ còn mất 30 phút! Thời gian
            được tiết kiệm một cách đáng kinh ngạc! 🚀
          </p>
          <p>
            Sự khác biệt ư? Bạn ấy đã ngừng coi Cursor là "phép thuật" và bắt
            đầu coi nó đúng như bản chất của nó: một lập trình viên junior rất
            thông minh, nhưng <strong>cần được chỉ dẫn rõ ràng</strong>! Giống
            như bạn đang hướng dẫn một người mới vào nghề vậy.
          </p>
          ...
          <p>
            ...
            câu hỏi, và nhận về một bản kế hoạch dự án đầy đủ kèm theo tất cả
            các tài liệu cần thiết. Sau đó, bạn ấy đưa những tài liệu này cho
            Cursor, và thế là có thể tận hưởng phần còn lại của ngày thay vì vật
            lộn trong mớ code hỗn loạn. Thật là một cách làm việc thông minh!
          </p>
          <p>
            Bạn ấy cũng hỏi cộng đồng xem có ai cũng phải học bài học này một
            cách khó khăn không, hay đã tìm ra cách dùng chỉ dẫn từ trước khi
            "tẩu hỏa nhập ma"?
          </p>
          <hr />
          ...
          <ul>
            ...
            <li>
              <strong>1clicktask (Tác giả)</strong>: Liên tục phủ nhận việc
              quảng cáo, nói rằng không hề "pitch" sản phẩm.
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>pajarator</strong>: Đồng ý rằng AI
              <strong>hành xử</strong> như một junior dev. Tuy nhiên, bản chất của
              nó vẫn là một LLM (mô hình ngôn ngữ lớn) phân tích và tạo code dựa
              trên hướng dẫn. Anh ấy nhấn mạnh rằng con người chúng ta thường bỏ
              qua những điều "hiển nhiên" khi giải thích, trong khi LLM lại dựa trên
              những gì nó được huấn luyện là "hiển nhiên", dẫn đến việc dễ đi chệch
              hướng. Anh ấy cũng đạt kết quả tốt nhất khi giải thích từ từ và kiểm
              tra kỹ lưỡng.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              để tạo kế hoạch, tài liệu và quy tắc so với việc viết code. Điều
              này cho thấy việc chuẩn bị là cực kỳ quan trọng.
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Aumpa</strong>: Đưa ra một giải pháp cực kỳ hữu ích: nên
              có một file chứa giải thích về kiến trúc ứng dụng cùng tất cả ngữ
              cảnh cần thiết. Khi bắt đầu phiên chat mới, chỉ cần yêu cầu AI
              "đọc file này". Anh ấy còn chia sẻ việc mình có cả một "series"
              file từ readme, to-do list, hướng dẫn cộng tác (làm từng bước
              một), tóm tắt dự án, log xử lý sự cố, file ghi nhớ (để đồng bộ ký
              ức từ các phiên trước), và thậm chí cả giao thức kết thúc phiên
              làm việc. Điều thú vị là chính AI đã giúp anh ấy tạo ra các file
              này! Anh ấy backup mọi thứ lên GitHub sau mỗi phiên.
            </li>
            <li>
              <strong>uptokesforall</strong>: Chia sẻ kinh nghiệm tương tự nhưng
              gặp vấn đề khi cho AI quá nhiều quyền tự quyết: nếu nói AI "tiếp
              tục kế hoạch" hơn hai lần, nó sẽ tự ý làm gộp các bước 3-10 với ít
              công sức hơn và cố gắng viết các log "làm cho có".
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              hoặc phương pháp BMAD (dựa trên Agile) để quản lý tác vụ.
              Taskmaster tự động tạo và chạy các tác vụ/tác vụ con. BMAD phức
              tạp hơn nhưng hiệu quả.
            </li>
            <li>
            ...
            <li>
              ...
              Taskmaster với Cursor hoặc Windsurf (một công cụ khác), nên không
              bị trùng lặp. Hiện tại thì dùng BMAD nhiều hơn, tuy chậm hơn nhưng
              hiệu quả với anh ấy.
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Aztec_Man</strong>: Đây là một trong những bình luận có
              giá trị nhất, cảnh báo về rủi ro bảo mật khi phát triển SaaS bằng
              vibecoding. Anh ấy gợi ý nên tập trung vào các vấn đề có rủi ro
              bảo mật thấp (như shaders, SVGs, plugins, prototypes) thay vì SaaS
              toàn diện.
              <ul>
                <li>
                  <strong>Lý do</strong>: Khi cung cấp hệ thống thanh toán hoặc
                  dịch vụ trực tuyến, rủi ro chính là
                  <strong>thỏa hiệp dữ liệu người dùng và bị kiện</strong>. Đây
                  là loại bug tồi tệ nhất.
                </li>
                <li>
                  <strong>Thách thức tương lai</strong>: Nếu AI thay thế nhiều
                  lập trình viên, có thể sẽ có nhiều "black hat" (hacker mũ đen)
                  gây rối qua các cuộc tấn công chuỗi cung ứng.
                </li>
                <li>
                  Anh ấy đã cung cấp các liên kết đến các cuộc thảo luận khác
                  trong cộng đồng r/vibecoding về chủ đề bảo mật và checklist
                  kiểm tra bảo mật cho code do AI tạo ra.
                </li>
              </ul>
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Aumpa</strong>: Dù chỉ học code 30 năm trước và chưa bao
              giờ là lập trình viên chuyên nghiệp, anh ấy vẫn coi mình là một
              "pure vibecoder" và thấy nó khá "trao quyền" (empowering) khi sử
              dụng Windsurf.
            </li>
          </ul>
          <hr />
          <p>
            <strong>Tóm lại:</strong> Bài học xương máu là AI không phải là phép
            thuật. Nó là một công cụ mạnh mẽ nhưng cần được hướng dẫn rõ ràng, chi
            tiết, giống như một lập trình viên junior thông minh cần sự định hướng
            từ senior vậy. Việc chuẩn bị tài liệu, cấu trúc dự án từ đầu sẽ giúp
            tiết kiệm rất nhiều thời gian và công sức debug về sau. Đồng thời, cộng
            đồng cũng cảnh báo về rủi ro bảo mật nghiêm trọng khi sử dụng AI để phát
            triển các hệ thống phức tạp như SaaS.
          </p>
          <!---->
        </div>
      </div>
