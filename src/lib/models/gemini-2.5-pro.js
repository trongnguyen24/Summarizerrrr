...
export const gemini25ProConfig = {
  ...
  buildYouTubePrompt: (text, lang, length, format) => {
    console.log('[buildYouTubePrompt] Variables:', {
  ...
  buildGeneralPrompt: (text, lang, length, format) => {
    console.log('[buildGeneralPrompt] Variables:', {
      text: text ? 'present' : 'missing',
      lang,
      length,
      format,
  ...
  buildChapterPrompt: (timestampedTranscript, lang, length) => {
    console.log('[buildChapterPrompt] Variables:', {
  ...
  buildSelectedTextPrompt: (text, lang, length, format) => {
    console.log('[buildSelectedTextPrompt] Variables:', {
      text: text ? 'present' : 'missing',
      lang,
      length,
      format,
