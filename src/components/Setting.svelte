...
>
  ...
  <div
    class="flex items-center text-[0.65rem] justify-center p-2 border-b border-border gap-2"
  >
    <button
      class="flex w-24 flex-col items-center gap-1 cursor-pointer py-2 px-4 rounded-md transition-colors duration-200 {activeTab ===
      'ai-model'
        ? ' text-primary'
