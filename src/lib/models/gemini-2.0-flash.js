...
export const gemini20FlashConfig = {
  ...
  buildYouTubePrompt: (text, lang, length, format) => {
    console.log('[buildYouTubePrompt - 2.0 Flash] Variables:', {
  ...
  buildGeneralPrompt: (text, lang, length, format) => {
    console.log('[buildGeneralPrompt - 2.0 Flash] Variables:', {
      text: text ? 'present' : 'missing',
      lang,
      length,
      format,
  ...
  buildChapterPrompt: (timestampedTranscript, lang, length) => {
    console.log('[buildChapterPrompt - 2.0 Flash] Variables:', {
  ...
  buildSelectedTextPrompt: (text, lang, length, format) => {
    console.log('[buildSelectedTextPrompt - 2.0 Flash] Variables:', {
      text: text ? 'present' : 'missing',
      lang,
      length,
      format,
  ...
  generationConfig: {
    ...
    temperature: 0.2, // Example value, adjust as needed
