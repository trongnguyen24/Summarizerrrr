...
<div class="flex flex-col w-36 mx-auto gap-4 flex-wrap justify-center">
  {#each actions as action}
    <button
      class="action-btn font-mono relative py-2 px-4 text-sm rounded-full border border-border bg-surface-2/50 hover:bg-surface-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
