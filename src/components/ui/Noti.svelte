<div
  class=" absolute mx-auto w-full font-mono flex flex-col justify-center max-w-120 bottom-2 z-50 p-2"
>
  <div
    class="bg-surface-2 w-full p-0.5 border text-text-secondary border-border rounded-4xl flex items-center gap-2"
  >
    <div
      class="w-7 h-7 flex items-center justify-center bg-blackwhite-5 rounded-full"
    >
      <svg
    ...
    <div class="text-xs">Gemini rate limit exceeded</div>
  </div>
</div>
