  ...
  })(
    {
        ...
        function (t, n, i) {
          ...
          i.encode = function (t, n, i) {
            ...
            return (
              ...
              u
                ? (s &&
                    u.push(String.fromCharCode.apply(String, e.slice(0, s))),
                  u.join(''))
      ...
      13: [
        function (t, n, i) {
          ...
          )).constructor = r).prototype.rpcCall = function t(i, n, r, u, e) {
              ...
              return s.rpcImpl(
                ...
                function (t, n) {
                  ...
                  if (!(n instanceof r))
                    try {
                      n =
                        r[s.responseDelimited ? 'decodeDelimited' : 'decode'](n)
                    } catch (t) {
      ...
      16: [
        function (t, n, i) {
          ...
          ;(a.create = l()),
            ...
            ((w.prototype = Object.create(o.prototype)).fn = function (
              t,
              n,
              i
            ) {
          ...
          ;(a.prototype.bytes = function (t) {
            ...
            (a.prototype.ldelim = function () {
              ...
              return (
                this.reset().uint32(i),
                i &&
                  ((this.tail.next = t.next), (this.tail = n), (this.len += i)),
                this
              )
            }),
