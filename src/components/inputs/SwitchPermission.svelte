...
<div class="flex flex-row items-center gap-0.5">
  <Switch.Root
    ...
    class="focus-visible:ring-primary group overflow-hidden relative  text-text-secondary flex items-center focus-visible:ring-offset-background pl-9 pr-2  transition-colors focus-visible:outline-hidden w-full h-9  cursor-pointer  focus-visible:ring-1 focus-visible:ring-offset-1 data-[state=checked]:border-border data-[state=checked]:text-white"
  >
    <div
    ...
    ></div>
    <span
      class="size-2.5 bg-white absolute transition-all rounded-full z-0 left-4 {checked
